...
const course = {
  ...
  description:
    "Học thiết kế UI/UX chuyên nghiệp với Figma, từ wireframe đến prototype hoàn chỉnh cho sản phẩm thực tế.",
  rating: 4.9,
  ratingCount: "3,421",
  students: "15,678 học viên",
  duration: "32 giờ",
  lastUpdated: "Cập nhật 02/2024",
  language: "Tiếng Việt",
  subtitles: ["Tiếng Việt"],
  image: "https://images.unsplash.com/photo-1522542550221-31fd19575a2d?auto=format&fit=crop&w=1600&q=80",
  categories: ["Thiết kế", "Beginner", "Bán chạy"],
  price: "799,000đ",
  ...
  learnWhat: [
    "Phân tích nhu cầu người dùng và xây dựng persona",
    "Thiết kế wireframe và layout chuẩn UX",
    "Sử dụng Figma để tạo UI component hiện đại",
    "Thiết lập prototype và handoff cho developer",
  ],
  stats: [
    { value: "88", label: "Bài học" },
    { value: "32 giờ", label: "Thời lượng" },
    { value: "Beginner", label: "Cấp độ" },
    { value: "Trọn đời", label: "Truy cập" },
  ],
  benefits: [
    { icon: PlayCircleIcon, text: "32 giờ video theo yêu cầu" },
    { icon: DocumentArrowDownIcon, text: "Template & asset Figma" },
    { icon: CheckBadgeIcon, text: "Chứng chỉ hoàn thành" },
    { icon: LanguageIcon, text: "Mentoring nhóm hàng tuần" },
  ],
  curriculum: [
    {
      ...
      topics: ["Quy trình UX", "User research cơ bản", "Persona & user journey"],
    },
    {
      title: "Thiết kế UI trong Figma",
      lessons: "14 bài học",
      duration: "2 giờ 45 phút",
      topics: ["Auto layout nâng cao", "Thiết kế hệ thống màu", "Component & variant"],
    },
    {
      title: "Prototype & Handoff",
      lessons: "16 bài học",
      duration: "3 giờ 20 phút",
      topics: ["Prototype tương tác", "Design system", "Handoff cho developer"],
    },
  ],
};
...
const courseId = "ui-ux-design-voi-figma";
