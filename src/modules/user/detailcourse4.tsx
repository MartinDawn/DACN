...
const course = {
  ...
  description:
    "Xây dựng API hiệu năng cao với Node.js, Express, MongoDB và triển khai thực tế.",
  rating: 4.8,
  ratingCount: "4,567",
  students: "18,923 học viên",
  duration: "38 giờ",
  lastUpdated: "Cập nhật 05/2024",
  language: "Tiếng Việt",
  subtitles: ["Tiếng Việt"],
  image: "https://images.unsplash.com/photo-1517433456452-f9633a875f6f?auto=format&fit=crop&w=1600&q=80",
  categories: ["Lập trình", "Intermediate", "Bán chạy"],
  price: "649,000đ",
  ...
  learnWhat: [
    "Tạo RESTful API với Express và TypeScript",
    "Thiết kế database MongoDB và Mongoose",
    "Xây dựng xác thực JWT và phân quyền",
    "Triển khai CI/CD lên cloud",
  ],
  stats: [
    { value: "110", label: "Bài học" },
    { value: "38 giờ", label: "Thời lượng" },
    { value: "Intermediate", label: "Cấp độ" },
    { value: "Trọn đời", label: "Truy cập" },
  ],
  benefits: [
    { icon: PlayCircleIcon, text: "38 giờ video theo yêu cầu" },
    { icon: DocumentArrowDownIcon, text: "Source code từng module" },
    { icon: CheckBadgeIcon, text: "Chứng chỉ hoàn thành" },
    { icon: LanguageIcon, text: "Hỗ trợ mentoring 1-1" },
  ],
  curriculum: [
    {
      title: "Kiến trúc Node.js hiện đại",
      lessons: "14 bài học",
      duration: "2 giờ 10 phút",
      topics: ["Async & Event Loop", "Cấu trúc dự án", "Routing nâng cao"],
    },
    {
      title: "Làm việc với dữ liệu",
      lessons: "16 bài học",
      duration: "3 giờ",
      topics: ["MongoDB & Mongoose", "Validation", "Aggregation Pipeline"],
    },
    {
      title: "Bảo mật và triển khai",
      lessons: "18 bài học",
      duration: "4 giờ",
      topics: ["JWT & Refresh Token", "Log & Monitoring", "Deploy lên Render/Heroku"],
    },
  ],
};
...
const courseId = "nodejs-backend-development";
